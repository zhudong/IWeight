package com.axecom.iweight.xinyu;
...
//        ActivityInfo activityInfo=this.getPackageManager().getActivityInfo(componentName, PackageManager.GET_META_DATA);
...
//            e.printStackTrace();
//        }
//        String foo =activityInfo.metaData.   getString("foo");





        SoftKeyborad.Builder builder = new SoftKeyborad.Builder(this);
        switch (v.getId()) {
